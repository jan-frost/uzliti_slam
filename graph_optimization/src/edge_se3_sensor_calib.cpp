...
#include <graph_optimization/edge_se3_sensor_calib.h>

namespace g2o {

  EdgeSE3SensorCalib::EdgeSE3SensorCalib() :
    BaseMultiEdge<6, Isometry3d>()
  {
      resize(4);
  }

  void EdgeSE3SensorCalib::initialEstimate(const OptimizableGraph::VertexSet& from, OptimizableGraph::Vertex* to)
  {
    (void) to;
  ...
  bool EdgeSE3SensorCalib::read(std::istream& is)
  {
    Vector6d p;
  ...
  bool EdgeSE3SensorCalib::write(std::ostream& os) const
  {
